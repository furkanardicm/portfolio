      ...
      <div className="container max-w-4xl">
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 mb-16">
          <div className="flex-1 text-center md:text-left">
            <div className="mb-6">
              <p className="text-base md:text-xl text-muted-foreground mb-2">{content[language].greeting}</p>
              <h1 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">{content[language].name}</h1>
              <h2 className="text-xl md:text-3xl text-muted-foreground mb-3 md:mb-4">{content[language].title}</h2>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">{content[language].description}</p>
            </div>
